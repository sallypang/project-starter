...
public class JCCExpressionsParser implements JCCExpressionsParserConstants {
  ...
  final public Statement Declaration() throws ParseException {
        ...
        NodeList<Assign> body = new NodeList<Assign>();
        Assign a;
        Expression retExp;
    retType = Type();
    id = Identifier();
    ...
    jj_consume_token(SEMICOLON);
    jj_consume_token(28);
          {if (true) return new FunctionDeclaration(retType, id, params, body, retExp);}
    throw new Error("Missing return statement in function");
  }
  ...
  final public List<Parameter> ParameterList() throws ParseException {
        List<Parameter> ret;
        Parameter p;
  ...
  final public Parameter Parameter() throws ParseException {
    ...
    t = Type();
    id = Identifier();
          {if (true) return new Parameter(t, id);}
    throw new Error("Missing return statement in function");
  }
...
/* PrimaryExpression is the expression that has highest precedence.*/
  ...
  final public Expression IdentExpression() throws ParseException {
        Expression e;
        IdentifierExp ie;
        String i;
        List<Expression> el;
    i = Identifier();
                         ie = new IdentifierExp(i); e = ie;
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case LPAREN:
      jj_consume_token(LPAREN);
      el = ExpressionList();
      jj_consume_token(RPAREN);
                                              e = new FunctionInvocation(i, el);
      break;
    default:
      jj_la1[13] = jj_gen;
      ;
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x1600000,0x1600000,0x1000000,0x600000,0x100000,0x600000,0x1000,0x20000,0xc000,0xc000,0x10000,0x1840200,0x1800200,0x200,0x100000,0x1840200,};
   }
